...
class EncDec(torch.nn.Module):
    def __init__(self, ich=1, och=1):
        ...
        self.up1   = unet_up(128)
        self.box4  = unet_box(128, 64)

        self.up2   = unet_up(64)
        self.box5  = unet_box(64, 32)

        self.up3   = unet_up(32)
        self.box6  = unet_box(32, 32)
    ...
    def forward(self, x):
        ...
        _box4_out    = self.box4(_up1_out)
        _up2_out     = self.up2(_box4_out)

        _box5_out    = self.box5(_up2_out)
        _up3_out     = self.up3(_box5_out)

        _box6_out    = self.box6(_up3_out)
